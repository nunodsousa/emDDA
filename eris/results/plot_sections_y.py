...
os.system("grep -v '^$' output_projectionaeo_ypol.dat > projectionaeo_ypol.dat")
os.system("grep -v '^$' output_projectionbeo.dat > projectionbeo_ypol.dat")

a = charge_Matrix("output_projectionaeo_ypol.dat", 7)
b = charge_Matrix("output_projectionbeo_ypol.dat", 7)
dir = charge_Matrix("output_sections_ypol.dat", 5) #resultudo directo do DDA

#print ae11


lambdaae11 = get_column(a,0)
reae11 = get_column(a,5)
imae11 = get_column(a,6)
rebo11 = get_column(b,3)
imbo11 = get_column(b,4)
...
os.system("rm projectionaeo_ypol.dat projectionbeo_ypol.dat")
