...
os.system("grep -v '^$' output_projectionaeo_zpol.dat > projectionaeo_zpol.dat")
os.system("grep -v '^$' output_projectionbeo_zpol.dat > projectionbeo_zpol.dat")

a = charge_Matrix("projectionaeo_zpol.dat", 7)
b = charge_Matrix("projectionbeo_zpol.dat", 7)
dir = charge_Matrix("output_sections_z.dat", 5) #resultudo directo do DDA

#print ae11


lambdaae11 = get_column(a,0)
reae11 = get_column(a,1)
imae11 = get_column(a,2)
